...
public class CadastroProduto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spnProduto = (Spinner) findViewById(R.id.spnProdutos);
        nomeProduto = (EditText) findViewById(R.id.editNomeProduto);
        preco = (EditText) findViewById(R.id.editPreco);
        ativo = (CheckBox) findViewById(R.id.cbxProdutoAtivo);
    ...
    {
        if(nomeProduto.getText()==null || nomeProduto.getText().equals(""))
        {
            msgError = "Preencha o campo Produto";
            return false;
        }

        if(preco.getText()==null || preco.getText().equals(""))
        {
